        ...
        <div id="contact">
            ...
            <div className="container">
                <div className="contact">
                    <h1 data-aos="fade-up">Contact <i class="far fa-envelope"></i></h1>
